...
- [x] Add `desktop-agent trace-health` for CLI and JSON monitoring of local
      trace counts.
...
- [x] Add schema version and generation timestamp metadata to benchmark JSON
      and Markdown reports.
- [x] Add benchmark report artifact manifests to JSON, Markdown, and replay
      output.
- [x] Include the primary benchmark report path in benchmark artifact
      manifests.
...
- [x] Add `desktop-agent replay` support for benchmark reports with acceptance,
      ...
      details.
- [x] Include benchmark schema and generation timestamp metadata in replay
      Markdown summaries.
...
- [x] Render compact benchmark trace-health summaries in trace-health Markdown
      rows.
- [x] Cover trace-health Markdown latest rows for benchmark health without
      artifact manifests.
- [x] Print benchmark artifact trace rows in plain trace-health CLI monitoring
      output.
- [x] Print latest trace rows in plain trace-health CLI monitoring output.
...
- [x] Add first social/content scale-out batch for profile and notification
      ...
      YouTube, and TikTok.
- [x] Add second social/content scale-out batch for message, search, and saved
      item review routines across LinkedIn, Medium, X/Twitter, Instagram,
      Facebook, YouTube, and TikTok.
- [x] Add third social/content scale-out batch for comments and analytics
      review routines across LinkedIn, Medium, X/Twitter, Instagram, Facebook,
      YouTube, and TikTok.
...
- [x] Verify packaged benchmark replay summaries include report artifact
      manifests.
- [x] Keep the packaged benchmark artifact manifest aligned with the primary
...
- [x] Verify packaged trace-health output renders warning-trace counts and
      warning sections.
- [x] Verify packaged trace-health `--fail-on-warning` fails on seeded warning
      traces.
...
- [x] KR4: Optional team/report server remains separate from local execution.
