...
Write-Host "$CommandPrefixText proof verify-promotion $(Join-Path $TraceRoot 'proof-suite-promotion.json') --write-status-json"
Write-Host "$CommandPrefixText proof verify-archive $(Join-Path $TraceRoot 'proof-suite-artifacts.zip') --write-status-json"
