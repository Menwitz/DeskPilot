...
Write-Host "$CommandPrefixText proof validate-suite $TraceRoot$AllowMissingVideo --require-preflight --require-review --write-report --write-status-json --write-runbook --write-archive"
